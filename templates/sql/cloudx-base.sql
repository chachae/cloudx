...
INSERT INTO `t_dept`
VALUES (3, 1, '开发二部', 2, '2018-01-04 15:42:29', '2020-05-30 17:57:11');
INSERT INTO `t_dept`
...
INSERT INTO `t_dept`
VALUES (8, 3, '开发二部（南方分部）', 0, '2020-05-30 17:58:46', NULL);
COMMIT;
...
BEGIN;
INSERT INTO `t_log`
VALUES (1, 'chachae', '新增部门', 79, 'com.cloudx.server.system.controller.DeptController.addDept()',
        ' dept: \"Dept(deptId=7, parentId=5, deptName=111212, orderNum=0, createTime=Sat May 30 17:04:10 CST 2020, updateTime=null, createTimeFrom=null, createTimeTo=null)\"',
        '169.254.202.65', '2020-05-30 17:04:11', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log`
VALUES (2, 'chachae', '删除部门', 165,
        'com.cloudx.server.system.controller.DeptController.deleteDepts()', ' deptIds: \"7\"',
        '169.254.202.65', '2020-05-30 17:04:18', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log`
VALUES (3, 'chachae', '更新部门', 62, 'com.cloudx.server.system.controller.DeptController.updateDept()',
        ' dept: \"Dept(deptId=3, parentId=2, deptName=开发二部, orderNum=2, createTime=null, updateTime=Sat May 30 17:56:53 CST 2020, createTimeFrom=null, createTimeTo=null)\"',
        '169.254.202.65', '2020-05-30 17:56:54', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log`
VALUES (4, 'chachae', '更新部门', 38, 'com.cloudx.server.system.controller.DeptController.updateDept()',
        ' dept: \"Dept(deptId=3, parentId=1, deptName=开发二部, orderNum=2, createTime=null, updateTime=Sat May 30 17:57:11 CST 2020, createTimeFrom=null, createTimeTo=null)\"',
        '169.254.202.65', '2020-05-30 17:57:11', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log`
VALUES (5, 'chachae', '新增部门', 52, 'com.cloudx.server.system.controller.DeptController.addDept()',
        ' dept: \"Dept(deptId=8, parentId=3, deptName=开发二部（南方分部）, orderNum=0, createTime=Sat May 30 17:58:46 CST 2020, updateTime=null, createTimeFrom=null, createTimeTo=null)\"',
        '169.254.202.65', '2020-05-30 17:58:46', '内网IP|0|0|内网IP|内网IP');
COMMIT;
...
VALUES (1, 'chachae', '2020-05-27 18:42:49', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'OSX', 'MSEdge');
INSERT INTO `t_login_log`
VALUES (2, 'chachae', '2020-05-27 20:29:12', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'OSX', 'MSEdge');
INSERT INTO `t_login_log`
VALUES (3, 'chachae', '2020-05-27 23:06:37', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'OSX', 'MSEdge');
INSERT INTO `t_login_log`
VALUES (4, 'chachae', '2020-05-28 12:28:39', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'OSX', 'MSEdge');
INSERT INTO `t_login_log`
VALUES (5, 'chachae', '2020-05-28 17:07:21', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'OSX', 'MSEdge');
INSERT INTO `t_login_log`
VALUES (6, 'chachae', '2020-05-28 17:10:55', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'OSX', 'MSEdge');
INSERT INTO `t_login_log`
VALUES (7, 'chachae', '2020-05-28 17:30:41', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'OSX', 'MSEdge');
INSERT INTO `t_login_log`
VALUES (8, 'chachae', '2020-05-28 17:45:51', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'OSX', 'MSEdge');
INSERT INTO `t_login_log`
VALUES (9, 'chachae', '2020-05-28 17:48:23', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'OSX', 'MSEdge');
INSERT INTO `t_login_log`
VALUES (10, 'chachae', '2020-05-28 17:51:24', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'OSX', 'MSEdge');
INSERT INTO `t_login_log`
VALUES (11, 'chachae', '2020-05-28 18:07:52', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'OSX', 'MSEdge');
INSERT INTO `t_login_log`
VALUES (12, 'scott', '2020-05-28 18:21:43', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'OSX', 'MSEdge');
INSERT INTO `t_login_log`
VALUES (33, 'chachae', '2020-05-30 18:59:28', '内网IP|0|0|内网IP|内网IP', '169.254.202.65',
        'Mac OS X 10.15.4', 'Microsoft Edge 83');
INSERT INTO `t_login_log`
VALUES (34, 'chachae', '2020-05-30 21:10:10', '内网IP|0|0|内网IP|内网IP', '169.254.202.65',
        'Mac OS X 10.15.4', 'Microsoft Edge 83');
COMMIT;
...
VALUES (1, 0, '系统管理', '/system', 'Layout', NULL, 'el-icon-set-up', '0', 1, '2017-12-27 16:39:07',
        '2019-07-20 16:19:04');
INSERT INTO `t_menu`
VALUES (2, 0, '系统监控', '/monitor', 'Layout', NULL, 'el-icon-data-line', '0', 2,
        '2017-12-27 16:45:51', '2019-01-23 06:27:12');
INSERT INTO `t_menu`
VALUES (3, 1, '用户管理', '/system/user', 'febs/system/user/Index', 'user:view', '', '0', 1,
        '2017-12-27 16:47:13', '2019-01-22 06:45:55');
INSERT INTO `t_menu`
VALUES (4, 1, '角色管理', '/system/role', 'febs/system/role/Index', 'role:view', '', '0', 2,
        '2017-12-27 16:48:09', '2018-04-25 09:01:12');
INSERT INTO `t_menu`
VALUES (5, 1, '菜单管理', '/system/menu', 'febs/system/menu/Index', 'menu:view', '', '0', 3,
        '2017-12-27 16:48:57', '2018-04-25 09:01:30');
INSERT INTO `t_menu`
VALUES (6, 1, '部门管理', '/system/dept', 'febs/system/dept/Index', 'dept:view', '', '0', 4,
        '2017-12-27 16:57:33', '2018-04-25 09:01:40');
INSERT INTO `t_menu`
...
INSERT INTO `t_menu`
VALUES (150, 2, '登录日志', '/monitor/loginlog', 'febs/monitor/loginlog/Index', 'monitor:loginlog', '',
        '0', 3, '2019-07-22 13:41:17', '2020-04-13 11:38:08');
INSERT INTO `t_menu`
VALUES (151, 150, '删除日志', NULL, NULL, 'loginlog:delete', NULL, '1', NULL, '2019-07-22 13:43:04',
        NULL);
INSERT INTO `t_menu`
VALUES (152, 150, '导出Excel', NULL, NULL, 'loginlog:export', NULL, '1', NULL, '2019-07-22 13:43:30',
        NULL);
INSERT INTO `t_menu`
VALUES (154, 0, '其他模块', '/others', 'Layout', '', 'el-icon-shopping-bag-1', '0', 6,
        '2019-07-25 10:16:16', '2020-04-14 18:38:20');
INSERT INTO `t_menu`
VALUES (155, 154, '导入导出', '/others/eximport', 'febs/others/eximport/Index', 'others:eximport', '',
        '0', 1, '2019-07-25 10:19:31', NULL);
INSERT INTO `t_menu`
VALUES (156, 0, '代码生成', '/gen', 'Layout', '', 'el-icon-printer', '0', 4, '2019-07-25 10:24:03',
        '2020-01-16 13:59:49');
INSERT INTO `t_menu`
VALUES (157, 156, '基础配置', '/gen/config', 'febs/gen/config/Index', 'gen:config', '', '0', 1,
        '2019-07-25 10:24:55', '2020-04-09 14:21:54');
INSERT INTO `t_menu`
VALUES (158, 156, '生成代码', '/gen/generate', 'febs/gen/generate/Index', 'gen:generate', '', '0', 2,
        '2019-07-25 10:25:26', '2019-07-25 11:13:20');
INSERT INTO `t_menu`
VALUES (159, 157, '修改配置', NULL, NULL, 'gen:config:update', NULL, '1', NULL, '2019-07-26 16:22:56',
        NULL);
INSERT INTO `t_menu`
VALUES (160, 158, '打包生成', NULL, NULL, 'gen:generate:gen', NULL, '1', NULL, '2019-07-26 16:23:38',
        '2019-07-26 16:23:53');
INSERT INTO `t_menu`
VALUES (163, 1, '客户端管理', '/client', 'febs/system/client/Index', 'client:view', '', '0', 5,
        '2019-09-26 22:58:09', NULL);
INSERT INTO `t_menu`
...
INSERT INTO `t_menu`
VALUES (168, 0, '静态组件', '/components', 'Layout', '', 'el-icon-present', '0', 7,
        '2019-12-02 16:41:28', '2020-04-14 18:38:23');
INSERT INTO `t_menu`
VALUES (169, 168, '二级菜单', '/two', 'demos/two/Index', '', '', '0', 1, '2019-12-02 16:41:51', NULL);
INSERT INTO `t_menu`
VALUES (170, 169, '三级菜单', '/three', 'demos/two/three/Index', '', '', '0', 1, '2019-12-02 16:42:09',
        NULL);
INSERT INTO `t_menu`
VALUES (171, 168, 'MarkDown', '/components/markdown', 'demos/markdown', '', '', '0', 2,
        '2019-12-02 16:42:34', NULL);
INSERT INTO `t_menu`
VALUES (172, 168, '富文本编辑器', '/components/tinymce', 'demos/tinymce', '', '', '0', 3,
        '2019-12-02 16:42:50', NULL);
INSERT INTO `t_menu`
VALUES (173, 0, '网关管理', '/route', 'Layout', '', 'el-icon-odometer', '0', 3, '2020-01-16 14:00:15',
        NULL);
INSERT INTO `t_menu`
VALUES (174, 173, '网关用户', '/route/user', 'febs/route/routeuser/Index', '', '', '0', 1,
        '2020-01-16 14:00:32', NULL);
INSERT INTO `t_menu`
VALUES (175, 173, '网关日志', '/route/log', 'febs/route/routelog/Index', '', '', '0', 2,
        '2020-01-16 14:00:47', NULL);
INSERT INTO `t_menu`
VALUES (176, 173, '限流规则', '/route/ratelimitrule', 'febs/route/ratelimitrule/Index', '', '', '0', 3,
        '2020-01-16 14:01:01', NULL);
INSERT INTO `t_menu`
VALUES (177, 173, '限流日志', '/route/ratelimitlog', 'febs/route/ratelimitlog/Index', '', '', '0', 4,
        '2020-01-16 14:01:17', NULL);
INSERT INTO `t_menu`
VALUES (178, 173, '黑名单管理', '/route/blacklist', 'febs/route/blacklist/Index', '', '', '0', 5,
        '2020-01-16 14:01:32', NULL);
INSERT INTO `t_menu`
VALUES (179, 173, '黑名单日志', '/route/blocklog', 'febs/route/blocklog/Index', '', '', '0', 6,
        '2020-01-16 14:01:49', NULL);
INSERT INTO `t_menu`
VALUES (180, 2, '监控面板', '/monitor/dashboard', 'febs/monitor/dashboard/Index', 'monitor:dashboard',
        '', '0', 1, '2020-04-13 09:44:09', '2020-04-13 11:38:00');
INSERT INTO `t_menu`
VALUES (181, 154, '个人博客', '/others/blog', 'febs/others/blog/Index', '', '', '0', 2,
        '2020-04-13 16:11:48', '2020-04-13 16:12:26');
INSERT INTO `t_menu`
VALUES (182, 154, '数据权限', '/others/datapermission', 'febs/others/datapermission/Index',
        'others:datapermission', '', '0', 3, '2020-04-14 14:51:35', '2020-04-14 15:37:19');
INSERT INTO `t_menu`
VALUES (183, 0, '任务调度', '/job', 'Layout', '', 'el-icon-alarm-clock', '0', 5, '2020-04-14 18:39:35',
        '2020-04-14 18:39:53');
INSERT INTO `t_menu`
VALUES (184, 183, '任务列表', '/job/list', 'febs/job/job/Index', 'job:view', '', '0', 1,
        '2020-04-14 18:40:37', '2020-04-14 18:41:36');
INSERT INTO `t_menu`
VALUES (185, 183, '调度日志', '/job/log', 'febs/job/log/Index', 'job:log:view', '', '0', 2,
        '2020-04-14 18:42:25', NULL);
INSERT INTO `t_menu`
VALUES (186, 184, '新增任务', NULL, NULL, 'job:add', NULL, '1', NULL, '2020-04-14 18:59:55',
        '2020-04-15 08:56:03');
INSERT INTO `t_menu`
...
INSERT INTO `t_menu`
VALUES (192, 184, '导出Excel', NULL, NULL, 'job:export', NULL, '1', NULL, '2020-04-14 19:01:59',
        NULL);
INSERT INTO `t_menu`
...
VALUES (1, 'chachae', '$2a$10$/YDnX1OPBCRcXHQx.aR3tu8f3JfM2ABdWv1fE.PZ32ijAbvqnPz5a', 2,
        'chachae@qq.com', '17788888888', '1', '2019-06-14 20:39:22', '2020-04-15 16:00:32',
        '2020-05-30 21:10:10', '0', '1', 'white', 'gaOngJwsRYRaVAuXXcmB.png', '我是帅比作者。');
INSERT INTO `t_user`
VALUES (2, 'scott', '$2a$10$/YDnX1OPBCRcXHQx.aR3tu8f3JfM2ABdWv1fE.PZ32ijAbvqnPz5a', 5,
        'scott@hotmail.com', '17720888888', '1', '2019-07-20 19:00:32', '2020-04-15 16:00:42',
        '2020-05-29 17:48:47', '2', NULL, NULL, 'BiazfanxmamNRoxxVxka.png', NULL);
INSERT INTO `t_user`
VALUES (3, 'Jane', '$2a$10$/YDnX1OPBCRcXHQx.aR3tu8f3JfM2ABdWv1fE.PZ32ijAbvqnPz5a', 4,
        'Jane@hotmail.com', '13679554032', '1', '2019-09-01 10:31:21', '2020-05-28 19:03:13',
        '2020-05-29 17:48:25', '1', NULL, NULL, '2dd7a2d09fa94bf8b5c52e5318868b4d9.jpg', NULL);
COMMIT;
