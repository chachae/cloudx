...
VALUES (136, 'cloudx-auth.yaml', 'DEFAULT_GROUP',
        ...
        'fcc201f7984ee4d72e22e16514aa149a', '2020-05-11 19:51:55', '2020-05-30 23:51:35', NULL,
        '120.239.18.255', '', '', 'null', 'null', 'null', 'yaml', 'null');
INSERT INTO `config_info`
VALUES (146, 'cloudx-gateway.yaml', 'DEFAULT_GROUP',
        ...
        '6cba39753ca65e3e0ddbf49cbba93e6b', '2020-05-11 20:59:19', '2020-05-30 23:52:27', NULL,
        '120.239.18.255', '', '', 'null', 'null', 'null', 'yaml', 'null');
INSERT INTO `config_info`
VALUES (148, 'cloudx-server-demo.yaml', 'DEFAULT_GROUP',
        'server:\n  port: 9501\n\nspring:\n  aop:\n    proxy-target-class: true\n  jackson:\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8\n  datasource:\n    hikari:\n      connection-timeout: 30000\n      max-lifetime: 1800000\n      connection-test-query: select 1\n      pool-name: CloudxHikariCP\n      maximum-pool-size: 15\n      minimum-idle: 5\n    username: root\n    password: 123456\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://${mysql.url}:3306/cloudx?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2b8\n  boot:\n    admin:\n      client:\n        url: http://${cloudx-admin}:8400\n        username: cloudx\n        password: 123456\n        instance:\n          prefer-ip: true\nfeign:\n  hystrix:\n    enabled: true\n\nhystrix:\n  shareSecurityContext: true\n  command:\n    default:\n      execution:\n        isolation:\n          thread:\n            timeoutInMilliseconds: 3000\n             \nmybatis-plus:\n  configuration:\n    jdbc-type-for-null: null\n  global-config:\n    banner: false\n    \nsecurity:\n  oauth2:\n    resource:\n      id: ${spring.application.name}\n      user-info-uri: http://${cloudx-gateway}:80/auth/user\n\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \'*\'\n  endpoint:\n    health:\n      show-details: ALWAYS\n      \ncloudx:\n  cloud:\n    security:\n      enable: true\n      anon-uris: /actuator/**',
        '74720f0f944a6ce0f8a0aeb66cbbe522', '2020-05-11 21:06:26', '2020-05-12 12:21:00', NULL,
        '106.15.202.13', '', '', 'null', 'null', 'null', 'yaml', 'null');
INSERT INTO `config_info`
VALUES (150, 'cloudx-server-system.yaml', 'DEFAULT_GROUP',
        'server:\n  port: 9500\n\nspring:\n  aop:\n    proxy-target-class: true\n  jackson:\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8\n\n  datasource:\n    hikari:\n      connection-timeout: 30000\n      max-lifetime: 1800000\n      connection-test-query: select 1\n      pool-name: CloudxHikariCP\n      maximum-pool-size: 15\n      minimum-idle: 5\n    username: root\n    password: 123456\n    driver-class-name: com.p6spy.engine.spy.P6SpyDriver\n    url: jdbc:p6spy:mysql://${mysql.url}:3306/cloudx?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2b8\n    \n  boot:\n    admin:\n      client:\n        url: http://${cloudx-admin}:8400\n        username: cloudx\n        password: 123456\n        instance:\n          prefer-ip: true\n\nmybatis-plus:\n  configuration:\n    jdbc-type-for-null: null\n  global-config:\n    banner: false\n      \nsecurity:\n  oauth2:\n    resource:\n      id: ${spring.application.name}\n      user-info-uri: http://${cloudx-gateway}:80/auth/user\n\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \'*\'\n  endpoint:\n    health:\n      show-details: ALWAYS\n      \ncloudx:\n  cloud:\n    security:\n      enable: true\n      anon-uris: /actuator/**',
        '98f101a8661169bebc46a908d7e817af', '2020-05-11 21:08:56', '2020-05-27 23:19:36', NULL,
        '106.15.202.13', '', '', 'null', 'null', 'null', 'yaml', 'null');
COMMIT;
...
BEGIN;
INSERT INTO `users`
VALUES ('cloudx', '$2a$10$2a4rD9WQOqZndDellHPoyeWsq6Wqq8VGgDenXMmXd/GCuisscGnUG', 1);
COMMIT;
